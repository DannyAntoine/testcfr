...
<div class="content-body">
  ...
  <div class="col-lg-8">
    <div class="d-flex align-items-center">
      <h4 class="text-primary mr-2">DECISION: <span class="text-muted"> Declined </span></h4>
                                                ...
                                                <div class="col-xl-8 col-sm-8 border-right-1 prf-col">
                                                    ...
                                                    <h4 class="text-primary">RECEIVED DATE : <span class="text-muted"> {{\Carbon\Carbon::parse($declined-> first() ->receivedDate)->format('m/d/Y h:i A')}} </span></h4>

                                                    <h4 class="text-primary">MOVE IN DATE : <span class="text-muted">{{\Carbon\Carbon::parse($declined-> first() ->MoveInDate)->format('m/d/Y h:i A')}} </span></h4>

                                                    <h4 class="text-primary">ENTERED DATE : <span class="text-muted"> {{\Carbon\Carbon::parse($declined-> first() ->daterequested)->format('m/d/Y h:i A')}} </span> </h4>

                                                    <h4 class="text-primary">DECELINE DATE : <span class="text-muted">{{\Carbon\Carbon::parse($declined-> first() ->datedeclined)->format('m/d/Y h:i A')}}</span></h4>
  ...
  <div class="col-lg-8">
    <div class="d-flex align-items-center">
      <h4 class="text-primary mr-2">Reason: <span class="text-muted"> {{$declined -> reason}} </span></h4>
...
<!-- profile tab modal-->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div id="cases" class="tab-pane fade">
                                                ...
                                                <h4 class="table table-striped table-responsive-sm">CASE ID : <span class="text-muted"> {{$declined -> id}} </span></h4>
